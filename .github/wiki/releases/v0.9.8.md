...
See: [CHANGELOG.md](https://github.com/nself-org/cli/blob/main/.wiki/releases/CHANGELOG.md) for complete version history
...
MIT License - See [LICENSE](https://github.com/nself-org/cli/blob/main/LICENSE) for details
